...
-- Remap '[' and ']' to last ane next paragraph
-- Remap '[' and ']' to last ane next paragraph
keymap.set("n", "K", "<Cmd>keepjumps normal! {<CR>")
keymap.set("n", "J", "<Cmd>keepjumps normal! }<CR>")
keymap.set("v", "K", "<Cmd>keepjumps normal! {<CR>")
keymap.set("v", "J", "<Cmd>keepjumps normal! }<CR>")
...
keymap.set("n", "<leader>ne", "<cmd>tabnew $MYVIMRC <bar> tcd %:h<cr>", {
  silent = true,
  desc = "open init.lua",
})
